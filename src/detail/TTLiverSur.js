...
import InstructionImage_1 from "../images/product/bg7.png";
...
export default () => {
  ...
  return (
    <AnimationRevealPage>
      <Header />
      <MainFeature
        subheading={'GAN TẠT CHUYÊN DÙNG ỨC CHẾ MẦM BỆNH GÂY RA CÁC BỆNH VỀ GAN, TỤY VÀ ĐƯỜNG RUỘT TRÊN TÔM, TĂNG TỶ LỆ SỐNG, KHỐNG CHẾ TÔM BỚT RỚT NHÁ'}
        heading={
          <>
            TT – LIVER SUR
            {/* <wbr />{" "}
